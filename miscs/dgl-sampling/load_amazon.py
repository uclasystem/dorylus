...
class AmazonDataset(DGLDataset):
    ...
    - Nodes: 9,200,041
    - Edges: 313,922,264
    - Node feature size: 96
    - Number of training samples: 6,071,760
    - Number of validation samples: 919,440
    - Number of test samples: 2,208,841
    ...
    labels :  Tensor
        Node labels
    """
    def __init__(self, raw_dir='/filepool/amazon/dgl-dataset', force_reload=False, verbose=False):
        super(RedditLargeDataset, self).__init__(name='amazon',
                                            raw_dir=raw_dir,
