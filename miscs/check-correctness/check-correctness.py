...
feat_file = "../../../data/fb/features"
label_file = "../../../data/fb/labels"
snap_file = "../../../data/fb/fb.graph"
...
with open(weights_file, "r") as fweights:
    ...
    for line in fweights.readlines():
        ...
        if line == "Matrix Dims: (602, 1000)":
            read_state, row_idx = 0, 0
        elif line == "Matrix Dims: (1000, 41)":
            read_state, row_idx = 1, 0
        elif len(line) > 0:
            weights[read_state][row_idx] = list(map(float, line.split()))
            row_idx += 1
# print(weights[0])
# print(weights[1])
